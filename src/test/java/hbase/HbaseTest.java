...
public class HbaseTest {
  ...
  public void getConfigAndConnection() {
    ...
    conf.set("hbase.zookeeper.quorum", "hadoop6");
  ...
  public void createTable() throws IOException {
    ...
    if (!admin.isTableAvailable(TableName.valueOf("test"))) {
      ...
      ColumnFamilyDescriptorBuilder cdb = ColumnFamilyDescriptorBuilder
          .newBuilder(Bytes.toBytes("testfm"));
      //获得列描述起
  ...
  public void insertOneData() throws IOException {
    ...
    Put put = new Put(Bytes.toBytes("524382618264914242"));
    //下面三个分别为，列族，列名，列值
    put.addColumn(Bytes.toBytes("info"), Bytes.toBytes("name"), Bytes.toBytes("尼玛"));
  ...
  public void querySingleRow() throws IOException {
    ...
    //获得一行
    Get get = new Get(Bytes.toBytes("524382618264914242"));
  ...
  public void singColumnFilter() throws IOException {
    ...
    SingleColumnValueFilter filter = new SingleColumnValueFilter(Bytes.toBytes("testfm"),
        Bytes.toBytes("name"),
  ...
  public void FilterSet() throws IOException {
    ...
    SingleColumnValueFilter filter1 = new SingleColumnValueFilter(Bytes.toBytes("testfm"),
        Bytes.toBytes("age"),
